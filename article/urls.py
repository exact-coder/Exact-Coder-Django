...
from article.views import articles,article_details,filter_articles,delete_comment,delete_replay,do_nothing

urlpatterns = [
    path("",articles,name="articles"),
    path("details/<slug:slug>",article_details,name="article_details"),# type: ignore
    ...
    path('do-nothing',do_nothing,name="do-nothing"),
